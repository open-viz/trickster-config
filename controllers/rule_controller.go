...
//+kubebuilder:rbac:groups=trickstercache.org,resources=rules,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=trickstercache.org,resources=rules/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=trickstercache.org,resources=rules/finalizers,verbs=update
...
func (r *RuleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&trickstercachev1alpha1.Rule{}).
		Complete(r)
}
